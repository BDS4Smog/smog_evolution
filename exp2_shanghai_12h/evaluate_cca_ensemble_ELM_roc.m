...
%%%%% air  + mete + air_surround + mete_surround + traffic + checkin + om_range
        ...
        T1 = my_predict(Tr(:,1), Tr(:,2:8), Tr(:,9:15), Te(:,1), Te(:,2:8), Te(:,9:15));
        T2 = my_predict(Tr(:,1), Tr(:,2:8), Tr(:,16:20), Te(:,1), Te(:,2:8), Te(:,16:20));
        T3 = my_predict(Tr(:,1), Tr(:,2:8), Tr(:,21:55), Te(:,1), Te(:,2:8), Te(:,21:55));
        T4 = my_predict(Tr(:,1), Tr(:,2:8), Tr(:,56:60), Te(:,1), Te(:,2:8), Te(:,56:60));
        T5 = my_predict(Tr(:,1), Tr(:,2:8), Tr(:,61:71), Te(:,1), Te(:,2:8), Te(:,61:71));
        T6 = my_predict(Tr(:,1), Tr(:,2:8), Tr(:,72:76), Te(:,1), Te(:,2:8), Te(:,72:76));
        T7 = my_predict(Tr(:,1), Tr(:,9:15), Tr(:,16:20), Te(:,1), Te(:,9:15), Te(:,16:20));
        T8 = my_predict(Tr(:,1), Tr(:,9:15), Tr(:,21:55), Te(:,1), Te(:,9:15), Te(:,21:55));
        T9 = my_predict(Tr(:,1), Tr(:,9:15), Tr(:,56:60), Te(:,1), Te(:,9:15), Te(:,56:60));
        T10 = my_predict(Tr(:,1), Tr(:,9:15), Tr(:,61:71), Te(:,1), Te(:,9:15), Te(:,61:71));
        T11 = my_predict(Tr(:,1), Tr(:,9:15), Tr(:,72:76), Te(:,1), Te(:,9:15), Te(:,72:76));
        
        T12 = my_predict(Tr(:,1), Tr(:,16:20), Tr(:,21:55), Te(:,1), Te(:,16:20), Te(:,21:55));
        T13 = my_predict(Tr(:,1), Tr(:,16:20), Tr(:,56:60), Te(:,1), Te(:,16:20), Te(:,56:60));
        T14 = my_predict(Tr(:,1), Tr(:,16:20), Tr(:,61:71), Te(:,1), Te(:,16:20), Te(:,61:71));
        T15 = my_predict(Tr(:,1), Tr(:,16:20), Tr(:,72:76), Te(:,1), Te(:,16:20), Te(:,72:76));
        
        T16 = my_predict(Tr(:,1), Tr(:,21:55), Tr(:,56:60), Te(:,1), Te(:,21:55), Te(:,56:60));
        T17 = my_predict(Tr(:,1), Tr(:,21:55), Tr(:,61:71), Te(:,1), Te(:,21:55), Te(:,61:71));
        T18 = my_predict(Tr(:,1), Tr(:,21:55), Tr(:,72:76), Te(:,1), Te(:,21:55), Te(:,72:76));  
        
        T19 = my_predict(Tr(:,1), Tr(:,56:60), Tr(:,61:71), Te(:,1), Te(:,56:60), Te(:,61:71));
        T20 = my_predict(Tr(:,1), Tr(:,56:60), Tr(:,72:76), Te(:,1), Te(:,56:60), Te(:,72:76));
        
        [T21,T_Expected] = my_predict(Tr(:,1), Tr(:,61:71), Tr(:,72:76), Te(:,1), Te(:,61:71), Te(:,72:76));
     ...
     %   fprintf('%f \n',TPR);
        ...
        fprintf('tmp_precision: %f \n',tmp_precision);
        fprintf('tmp_recall: %f \n',tmp_recall);
    end
end
...
function [rd] = equalize_label(d)
    ...
    if length(indexes0)<num1
        num1 = length(indexes0);
    end
