...
air_f1 = ['air/' station '_' type1 '.txt'];
air_f0 = ['air/' station '_' type2 '.txt'];
mete_f1 = ['mete/' station '_' type1 '.txt'];
mete_f0 = ['mete/' station '_' type2 '.txt'];
air_surround_f1 = ['air_surround/' station '_' type1 '.txt'];
air_surround_f0 = ['air_surround/' station '_' type2 '.txt'];
mete_surround_f1 = ['mete_surround/' station '_' type1 '.txt'];
mete_surround_f0 = ['mete_surround/' station '_' type2 '.txt'];
air_surround_diff_f1 = ['air_surround_diff/' station '_' type1 '.txt'];
air_surround_diff_f0 = ['air_surround_diff/' station '_' type2 '.txt'];
