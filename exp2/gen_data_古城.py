...
collection_weather = db_weather.Gucheng  ###################### Need to change when changing station ######################
#collection_b = db1.BJ_Weather_Forecast


ofile=codecs.open(u'hours_古城_increase_data.txt', 'w',"utf-8")
result = {}
m_result = [{}]*len(cities)
print 'Ready' 
ifile=codecs.open(u'hours_古城_increase.txt', 'r',"utf-8") ###################### Need to change when changing station ######################
